...
Another approach could solve some of the problems above. In case of the neutrino description only as a propagator between production and detection point the normalization and all the conservation laws will come out of the box without manual tuning~\cite{Akhmedov2010a}.
