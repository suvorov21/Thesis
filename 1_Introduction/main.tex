...
% Neutrino physics is a very promising field of particle physics. The discovery of neutrino oscillations was an important milestone as a non-zero neutrino mass was proven. At the moment neutrino experiments are performing precise measurements of the oscillation parameters. In particular, $\delta_{CP}$ phase is interesting as it allows Charge-Parity violation in the process of neutrino oscillations. There are two ways to study neutrino oscillations: observing the reduction of the neutrino of the initial flavor (disappearance) and observing neutrino of other flavor comparing to initially produced (appearance). Only appearance channel is sensitive to the CP--violation. The accelerator experiments provides a unique possibility to study both neutrino/anti--neutrino and appearance/disappearance channels. Thus this kind of experiments is very powerful to the $\delta_{CP}$ measurements.

% Tokai-to-Kamioka (T2K) is a long--baseline oscillation experiment placed in Japan. It uses a beam from a 30 GeV proton accelerator J--PARC to produce an intense pure beam of muon neutrino. The oscillated beam is studied with a far detector Super--Kamiokande. It is a 50 kt water Cherenkov detector. Before the oscillations flux is measured by the near detector (ND280). ND280 provides a sufficient reduction of the systematic uncertainty in the oscillation analysis. The T2K experiment performed the first measurement of the mixing angle $\theta_{13}$ and the most precise measurement of mixing angle $\theta_{23}$. Recently the T2K collaboration reported constraining the value of the $\delta_{CP}$ with 3$\sigma$ confidence interval. The current measurements of the $\delta_{CP}$ are limited by the statistics. The T2K run was extended with a final goal of collecting $20\times10^{21}$ protons on target. At this statistics the systematic uncertainties of the CP--violation measurements will dominate. The neutrino interaction model uncertainties is dominating in the $\delta_{CP}$ measurements. The uncertainties reduction can be done with either detector configuration upgrade or a new analysis technique. Both approaches are overviewed in the current thesis.
...
% The near detector of the T2K experiment ND280 provides a remarkable reduction of uncertainties from 14\% down to 7\% with flux times neutrino cross--section measurements. But its performance may be further improved. The current setup has a limited acceptance for high-angle tracks. The energy threshold of hadron detection is high, thus not all the secondary particles from neutrino interactions are detected and reconstructed neutrino energy is smeared. Neutrino interaction cross--sections and nuclear models can not be precisely probed. To gain accuracy of the neutrino interaction measurements an upgrade of the ND280 is being performed~\cite{Abe2019}. A combination of the fine--grained scintillator detector (FGD) and vertical Time Projection Chambers (TPC) has been shown to provide good performance in particle tracking, charge and particle identification, momentum measurements.
...
% A new fully active fine--grained scintillator detector SuperFGD~\cite{Blondel2018} will be installed as an additional neutrino target. It is made from 1 cm${}^3$ cubes and performs tracking in 3D. The dimensions of the new detector are 192$\times$184$\times$56 cm${}^3$ and a fiducial mass is ~2 tons. Fine granularity reduces the threshold for hadron and muon detection. Nearly all the charged secondary particles from neutrino interactions are going to be detected. The detector will be capable for particle type identification for self--contained particles. With the new detector the accuracy of neutrino interaction measurements will be increased.
...
% A beamtest were performed to test the new detector characteristics. I participated the prototype construction and tests. We observed a high light yield at the level of 40 photo electrons per channel with a beam of minimum ionizing particles. The time resolution was estimated at the level of 1 ns. The tests confirmed a big potential of the new detector scheme. High light yield and accurate time measurements makes possible an accurate measurement of neutrino interactions.
...
% A simulation toolkit for the SuperFGD detector was developed. I calibrated detector response simulation with the data taken during the beamtest. I estimated the light yield for different event topologies. The simulation of the optical cross-talk between the cubes was done. With such a simulation I demonstrated that the detector can separate different particles with the measurements of the deposited energy. The dynamic range of the MPPCs is large enough (2668 pixels) to measure the stopping protons that will provide at most 600 photoelectrons. I estimated a threshold for the low energy proton detection at the level of 300 MeV/c that is much lower then the current value 600 MeV/c. The proton from neutrino interactions in ND280 are expected to have momentum started from 200 MeV/c. Thus majority of the protons can be detected in SuperFGD and their energy can be reconstructed.
...
% Two new TPCs will be installed above and below the SuperFGD. They will provide precise tracking, identification of the charge and particle type, accurate momentum measurements. The full 4$\pi$ angular acceptance of the secondary particles from neutrino interactions will be reached. Resistive Micromegas will be used as a sensitive detector. A resistive foil over the usual Micromegas detector is responsible for the charge sharing between sensitive pads and improving the spatial resolution keeping the pad size the same. Therefore the momentum resolution becomes better.
...
% The prototypes of the new detectors were constructed and tested with beams of charged particles. The performance of the TPC detector was found to exceed the expectations. Spatial resolution for tracks that are parallel to pad borders was measured at the level of 200 $\mu$m. The spatial resolution of the current TPC in similar conditions is 600 $\mu$m. Such an improvement will make possible very precise measurements of the momentum of the secondary particles, thus accurate probe of neutrino interaction models. The energy resolution was estimated at the same level as we observed in the existing TPC (10\% for one module).
...
% With the combination of new detectors SuperFGD and horizontal TPCs we are going to decrease the systematic uncertainty in the oscillation analysis from 7\% to 4\%. New detectors will provide more detailed information about neutrino interactions, thus new analysis methods have to be developed. A new method of anti-neutrino energy reconstruction using the neutron time of flight energy measurements in SuperFGD was proposed. With the simulation toolkit of the SuperFGD, I demonstrated that with this additional information, the interaction over Hydrogen can be separated from the interactions over Carbon. Hence we can select a sample of neutrino interactions over Hydrogen that is free from nuclear effects and reconstruct neutrino energy in a very precise way. The dependence of the neutrino energy reconstruction accuracy from the poorly studied nuclear effects was proved to be eliminated with the neutron kinematics measurements~\cite{Munteanu2019}. This method will allow us to constrain both flux normalization and shape that is critical for precise measurements of the $\delta_{CP}$ phase.
...
% Accelerator neutrino experiments are capable not only to measure the oscillation parameters, but to perform a search of the physics beyond the Standard Model (SM). A neutrino oscillation phenomenon explicitly indicates that neutrino is massive. However, in the Standard Model neutrino are massless. The explanation of the neutrino mass nature requires implementation of the new particles. A hypothesis proposing Heavy Neutral Leptons (HNL) is an extension of the SM that can explain the nature of the neutrino mass, existence of the Dark Matter and baryon asymmetry of the Universe. There is no guidance about the mass of the HNL. It can take any value from eV scale up to GUT scale. The GeV scale heavy neutrinos can be found in the existing experiments.
...
% A search of the HNL decays was performed with the near detector of the T2K experiment. Heavy neutrinos are expected to be produced in the meson decay. With T2K beamline, intense beam of kaons is produced. Thus the search of the HNL with masses $M_N < 500$ MeV/c${}^2$ is possible. I concentrated on the search of the two body decays $N\to\mu\pi$, $N\to e\pi$ and dimuon mode $N\to\mu\mu\nu$. I expect the main background to come from an interactions of active neutrino. To minimize such a background the active volume of the TPC was chosen for the search of HNL decays. The atmospheric pressure TPC will contain $10^3$ times less neutrino interactions comparing to the scintillator detector. Thus the background is naturally suppressed. The ND280 tracker already demonstrated good performance and ability to identify particle's charge and type. That is very helpful in the searches for neutral particle decay.
...
% Expected signal events were simulated in the detector. The accurate simulations of the kaon decay into active neutrino ($K\to\mu\nu$) was already performed in T2K. I used the information from kaon decays from this simulation. All the decays were re-simulated for the HNL production, taking into account changed decay kinematics and branching ratios. With such a procedure I obtained the HNL spectra at the ND280 site. After that I simulated heavy neutrino decays in ND280 TPCs and estimated detector response for the signal events.
...
% Kinematic spectra of the daughter particles were studied in order to separate them from the neutrino interactions in gas. A cut sequence was developed to suppress the background from the neutrino interactions. The kinematics cut are the most powerful in the background elimination. The HNL direction is extremely collinear to the beam. As both particles in the HNL decay are detected I can reconstruct the direction of the HNL candidate. On the opposite side, neutrino interactions produce particles in a wide angle that is different from the 2-body decay kinematics. In addition the reconstructed HNL invariant mass should be higher then the product mass and lower then the kaon mass that implements an other powerful background constrain.
...
% The final efficiency for the signal detection was observed at the level of 20\% and nearly no background was expected. The signal efficiency is limited by the detector design. HNL decays produce two collinear particles that is not easy to separate in the ND280 TPCs. Nevertheless relatively high efficiency allow us to perform a sensitive search for the HNL decays in ND280.
...
% The systematic uncertainties in the HNL search were estimated. The final limits on the existence of the hNL are set based on the number of predicted events. This number is estimated based on the HNL flux and detector efficiency. Both of them are the subject of systematic uncertainties. The uncertainties of the HNL flux are dominated by the kaon production multiplicities. These processes were measured by NA61 experiment. I estimated the systematics based on their measurements at the level of 20\%. The other source of uncertainties is detector systematics. The detector systematic was estimated based on the comparison of the Monte--Carlo and data samples for each particular source of the uncertainty. The total value of the detector systematics was estimated at level of 4\%.
...
% After data unblinding only one event in the $N\to\mu\mu\nu$ mode was observed. No events were observed in the 2-body decay modes $n\to\mu\pi$ and $N\to e\pi$. A strong upper limit on the existence of the heavy neutrino with $M_N < 500$ MeV/c${}^2$ was set using Highland and Cousins method. The best result was achieved at the high mass. Mixing elements were constrained with $\left|U_e\right|^2 < 2\times10^{-9}$ for $M_N > 420$ MeV/c${}^2$ and $\left|U_e\right|^2 < 3\times10^{-9}$ for $M_N > 350$ MeV/c${}^2$. This result improved the previous analysis done by the PS191 experiment~\cite{Abe2019l}.
...
A separate thanks to the LPNHE group who gave me a warm reception and provided an office during the last days of my Ph.D.
