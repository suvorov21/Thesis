...
\begin{figure}[!ht]
  ...
  \begin{minipage}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{p_thr} \\ (a)
  \end{minipage}
  \begin{minipage}{0.49\linewidth}
    \centering
    \includegraphics[width=\linewidth]{p_sim} \\ (b)
  \end{minipage}
...
% The detailed description of the method is provided in \autoref{sec:intro:pt} of \autoref{ch:nu_phys}.
...
\begin{figure}[!ht]
	...
	\begin{minipage}{0.49\linewidth}
		\centering
		\includegraphics[width=\linewidth]{smear_70} \\ (b)
	\end{minipage}
